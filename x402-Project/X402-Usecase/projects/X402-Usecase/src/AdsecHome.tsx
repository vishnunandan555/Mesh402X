...
const STATS = [
  ...
  { value: '$0.001', label: 'floor price / call' },
          ...
          <div className="mb-10 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
            <div>
              <p className="text-xs font-mono uppercase tracking-[0.3em] text-cyan-400 mb-3">
                {currentView === 'playground' ? 'live playground' : 'on-chain receipts'}
              </p>
              <h2 className="text-3xl sm:text-4xl font-black tracking-tight">
                {currentView === 'playground' ? 'Fire a real audit' : 'Algorand TestNet Ledger'}
              </h2>
              <p className="mt-3 text-slate-400 max-w-xl">
                {currentView === 'playground'
                  ? 'Load a vulnerable preset or paste your own code, then watch the terminal walk through attack, challenge, signature, settlement and patching.'
