...
const TIERS = [
  ...
  },
  {
    ...
    name: 'Free Dev Test',
    price: '$0.00 (Free)',
    priceMicro: '0 microUSDC',
    endpoint: 'POST /adsec/dev-audit',
    script: 'npx tsx medusa-scripts/audit-dev.ts <file>',
    badge: '🟢 Zero Wallet Setup',
    badgeColor: 'bg-slate-500/10 text-slate-300 border-slate-500/30',
    description: 'Public testing endpoint to verify security diagnostics, health score, and AST rules without needing TestNet tokens.',
    icon: '🧪',
  },
]
